      ...
      <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[1fr_0.9fr]">
        <div className="surface-panel rounded-2xl p-8 sm:p-10">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            <div className="surface-panel surface-hover rounded-xl p-4">
        ...
        <aside className="surface-panel rounded-2xl p-8 sm:p-10">
          ...
          <div className="mt-6 grid gap-3">
            {socialLinks.map((item) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="surface-panel surface-hover flex items-center justify-between rounded-xl px-4 py-4 text-sm font-semibold text-[var(--foreground)]"
              >
          ...
          <div className="surface-panel mt-8 rounded-xl p-5">
